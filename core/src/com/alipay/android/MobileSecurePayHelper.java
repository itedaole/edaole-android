 ...
 * 
 */
public class MobileSecurePayHelper implements Callback {
	...
	public static PackageInfo
	        getApkInfo(Context context, String archiveFilePath) {
	...
	public boolean retrieveApkFromNet(Context context, String strurl,
		...
		boolean bRet = false;
		try {
			NetworkManager manager = new NetworkManager(this.mContext);
			bRet = manager.urlDownloadToFile(context, strurl, filename);
		} catch (Exception e) {
			e.printStackTrace();
		}
	...
	public boolean handleMessage(Message msg) {
		if (msg.what == AlixId.RQF_INSTALL_CHECK) {
			closeProgress();
