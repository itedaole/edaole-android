...
public abstract class UserTask<Params, Progress, Result> {
    ...
    private static final DiscardOldestPolicy sRejectedHandler = new ThreadPoolExecutor.DiscardOldestPolicy() {

        @Override
        public void rejectedExecution(Runnable r, ThreadPoolExecutor e) {
            super.rejectedExecution(r, e);
            Log.e(LOG_TAG, "handle rejectedExecution - Largest: " + e.getLargestPoolSize());
        }
